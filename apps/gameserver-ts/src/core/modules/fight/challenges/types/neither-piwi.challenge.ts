...
@Injectable()
@Challenge(29)
export class NeitherPiwiChallenge extends FightChallenge {
  readonly challengeId = 29;
  readonly challengeName = "Neither Piwi Nor Submissive";
  ...
  onFighterDied(_f: Fight, fighter: Fighter): void {
    ...
    if (lastAttacker?.player && lastAttacker.player.sex === 1) {
