...
import { STAT_IDS, STAT_NAMES } from "@/game/types/stats";
...
export function StatsPanel({
  ...
  const getStatValue = (
    stat: StatValue
  ): { base: number; total: number; bonus: number } => {
    ...
    >
      ...
      >
        ...
        <div style={{ position: "relative", width: "100%", height: "100%" }}>
          ...
          {/* Energy row (y=53) */}
          <div
            style={{ position: "absolute", left: p(20), top: p(57), zIndex: 1 }}
          >
            <span
              style={{
                fontSize: p(11),
          ...
          {/* XP row (y=73) */}
          <div
            style={{ position: "absolute", left: p(20), top: p(77), zIndex: 1 }}
          >
            <span
              style={{
                fontSize: p(11),
          ...
          {/* HP row (y=92) */}
          <div
            style={{ position: "absolute", left: p(20), top: p(96), zIndex: 1 }}
          >
            <img
              src={ICON_MAP.hp}
              alt="HP"
