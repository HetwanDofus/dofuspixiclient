...
const _FEUX_MANIFEST: SpriteManifest = {
  width: 9,
  height: 9,
  offsetX: -4.55,
  offsetY: -4.4,
...
const _PLUMES2_MANIFEST: SpriteManifest = {
  width: 14.6,
  height: 14.6,
  offsetX: -6.9,
  offsetY: 17.55,
...
const _PLUMES_MANIFEST: SpriteManifest = {
  width: 14.6,
  height: 14.6,
  offsetX: -9.9,
  offsetY: -52.45,
...
export class Spell2928 extends BaseSpell {
  ...
  private spawnParticles(): void {
    ...
    for (let i = 1; i < 20; i++) {
      ...
      const _vyWorld = vxLocal * Math.sin(parentRotRad) + g;
