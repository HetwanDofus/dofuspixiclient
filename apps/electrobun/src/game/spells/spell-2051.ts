...
export class Spell2051 extends BaseSpell {
  ...
  protected setup(
    ...
    this.impactAnim.stopAt(81).onFrame(54, () => this.signalHit());
    ...
    this.projectileSprite = this.anims.add(
      new FrameAnimatedSprite({
    ...
    this.projectileSprite.onFrame(0, () =>
