...
const _MINIFEUX3_MANIFEST: SpriteManifest = {
  width: 2.45,
  height: 2.05,
  offsetX: 0.2,
  offsetY: -1.2,
...
const _MINIFEUX2_MANIFEST: SpriteManifest = {
  width: 2.45,
  height: 2.05,
  offsetX: 0.2,
  offsetY: -1.2,
...
const _MINIFEUX_MANIFEST: SpriteManifest = {
  width: 2.45,
  height: 2.05,
  offsetX: 0.2,
  offsetY: -1.2,
...
export class Spell2903 extends BaseSpell {
  ...
  update(deltaTime: number): void {
    ...
    if (
      this.mainStopped &&
      !this.minifeux4Particles.hasAliveParticles() &&
