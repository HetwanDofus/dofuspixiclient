...
export class Spell616 extends BaseSpell {
  ...
  protected setup(
    ...
    const sprite20Anim = this.anims.add(
    ...
    const sprite8Anim = this.anims.add(
      new FrameAnimatedSprite({
    ...
    this.mainTargetAnim = this.anims.add(
      new FrameAnimatedSprite({
    ...
    this.mainTargetAnim.onFrame(63, () =>
      this.callbacks.playSound("dodge_616b")
    );
