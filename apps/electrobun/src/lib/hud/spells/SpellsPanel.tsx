  ...
  return (
    <Panel title="Sorts" width={250} height={390} onClose={onClose} zoom={zoom}>
      <div style={{ position: "relative", width: "100%", height: "100%", fontSize: p(11) }}>
        ...
        {/* Filter buttons row */}
        <div style={{ position: "absolute", left: p(6), top: p(20), display: "flex", flexWrap: "wrap", gap: p(4), width: p(240) }}>
        ...
        >
          {[...Array(12)].map((_, i) => (
            ...
            >
              <img src="/themes/classic/assets/panels/spells/spell-slot-background.svg" alt="spell" style={{ width: p(20), height: p(20) }} />
              <div />
            </div>
          ))}
        </div>
