...
import { hudStore, toggleWorldMap } from "@/stores";
 ...
 */
export function WorldMapPanel({ visible, zoom, canvasWidth, canvasHeight }: WorldMapPanelProps) {
  ...
  return (
    ...
    >
      ...
      >
        <span style={{ color: "white", fontWeight: "bold", fontSize: 13, fontFamily: "Verdana, sans-serif" }}>
          Carte du monde
        </span>
        <img
      ...
      >
        <kbd style={{ background: "#333", padding: "2px 8px", borderRadius: 3, border: "1px solid #555", fontWeight: "bold", fontFamily: "monospace" }}>M</kbd> Fermer
        {" | "}
        <kbd style={{ background: "#333", padding: "2px 8px", borderRadius: 3, border: "1px solid #555", fontWeight: "bold", fontFamily: "monospace" }}>Glisser</kbd> Déplacer
        {" | "}
        <kbd style={{ background: "#333", padding: "2px 8px", borderRadius: 3, border: "1px solid #555", fontWeight: "bold", fontFamily: "monospace" }}>Molette</kbd> Zoom
      </div>
    </div>
  );
}
