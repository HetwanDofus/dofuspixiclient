...
export function QuestsPanel({ onClose, zoom = 1 }: QuestsPanelProps) {
  ...
  return (
    <Panel title="Quêtes" width={280} height={312} onClose={onClose} zoom={zoom}>
      <div style={{ position: "relative", width: "100%", height: "100%", fontSize: p(11) }}>

        {/* Tab bar */}
        <div style={{ position: "absolute", left: 0, top: 0, width: "100%", height: tabBarH, display: "flex", borderBottom: `${p(1)}px solid var(--dofus-bar-border, #514a3c)` }}>
          <button
            onClick={() => setActiveTab("current")}
            style={{
              flex: 1,
              background: activeTab === "current" ? "var(--dofus-header-bg, #514a3c)" : "transparent",
              color: activeTab === "current" ? "var(--dofus-text-white, #ffffff)" : "var(--dofus-text-dark, #514a3c)",
              border: "none",
          ...
          <button
            ...
            style={{
              flex: 1,
              background: activeTab === "all" ? "var(--dofus-header-bg, #514a3c)" : "transparent",
              color: activeTab === "all" ? "var(--dofus-text-white, #ffffff)" : "var(--dofus-text-dark, #514a3c)",
              border: "none",
              padding: `${p(4)}px ${p(8)}px`,
              cursor: "pointer",
              fontSize: p(10),
        ...
        >
          ...
          />
          <label style={{ cursor: "pointer", fontSize: p(10) }}>
            Quêtes terminées
          </label>
        </div>
