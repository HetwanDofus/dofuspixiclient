...
import { computeMapScale } from "./datacenter";
import { TileLayerBuilder } from "./tile-layer-builder";
...
export class MapHandler {
  ...
  async renderMap(
    ...
    if (backgroundNum && backgroundNum > 0) {
      this.layerBuilder.renderBackground(backgroundNum, this.backgroundLayer, mapScale);
    }
