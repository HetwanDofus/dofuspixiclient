...
export type ThemeColorTokens = {
  ...
  /* combat */
  'combat-spell-slot-bg': string;
  'combat-spell-slot-active': string;
  'combat-spell-highlight': string;
  'combat-ap-cost-text': string;
  'combat-action-bar-bg': string;
  'combat-ap': string;
  'combat-mp': string;
  'combat-pass-turn': string;
  'combat-forfeit': string;
};
