...
function buildColorTokens(c: ThemeColors): ThemeColorTokens {
  return {
    ...
    "combat-spell-slot-bg": hex(c.combat.spellSlotBg),
    "combat-spell-slot-active": hex(c.combat.spellSlotActive),
    "combat-spell-highlight": hex(c.combat.spellHighlight),
    "combat-ap-cost-text": hex(c.combat.apCostText),
    "combat-action-bar-bg": hex(c.combat.actionBarBg),
    "combat-ap": hex(c.combat.apBar),
    "combat-mp": hex(c.combat.mpBar),
    "combat-pass-turn": hex(c.combat.passTurnButton),
    "combat-forfeit": hex(c.combat.forfeitButton),
  };
}
