    ...
    >
      ...
      <span
        className={cn(
          ...
          effectiveState === "unaffordable" && "opacity-60 saturate-50",
          effectiveState === "pending" && "opacity-80 animate-pulse",
        )}
      >
        {children}
      </span>
      ...
      {apCost !== undefined && apCost > 0 && (
        <span
          className={cn(
            ...
            "text-[calc(8px*var(--resolution-factor))] leading-none font-bold",
