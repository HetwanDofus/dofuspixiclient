...
export class Spell2901 extends BaseSpell {
  ...
  protected setup(context: SpellContext, textures: SpellTextureProvider, init: SpellInitContext): void {
    ...
    this.feuxAnim = this.anims.add(new FrameAnimatedSprite({
    ...
    this.minifeux4Anim = this.anims.add(new FrameAnimatedSprite({
    ...
    this.minifeux3Anim = this.anims.add(new FrameAnimatedSprite({
    ...
    this.minifeux2Anim = this.anims.add(new FrameAnimatedSprite({
    ...
    this.minifeuxAnim = this.anims.add(new FrameAnimatedSprite({
