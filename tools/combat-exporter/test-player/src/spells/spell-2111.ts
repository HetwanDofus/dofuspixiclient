...
export class Spell2111 extends BaseSpell {
  ...
  private bulletBaseX = 0;
  private bulletBaseY = 0;

  // Trail particle counter
  private trailCounter = 100;

  // Bullet phase: 0=stopped (ellipse), 1=playing out (gotoAndPlay(2))
  private bulletPhase = 0;
  ...
  protected setup(context: SpellContext, textures: SpellTextureProvider, init: SpellInitContext): void {
    ...
    this.bulletBaseX = 0; // container is positioned at cellFrom by the combat system
    this.bulletBaseY = 0;
