...
export class Spell1056 extends BaseSpell {
  ...
  protected setup(context: SpellContext, textures: SpellTextureProvider, init: SpellInitContext): void {
    ...
    if (textures.hasTexture('sprite_67_0')) {
      ...
      const anim67 = this.anims.add(new FrameAnimatedSprite({
      ...
      anim67
        .stopAt(9)
        .onFrame(0, () => this.callbacks.playSound('death'));
    ...
    if (textures.hasTexture('sprite_61_0')) {
      ...
      const anim61 = this.anims.add(new FrameAnimatedSprite({
    ...
    if (textures.hasTexture('sprite_55_0')) {
      ...
      const anim55 = this.anims.add(new FrameAnimatedSprite({
    ...
    if (textures.hasTexture('sprite_19_0')) {
      ...
      const anim19 = this.anims.add(new FrameAnimatedSprite({
    ...
    if (textures.hasTexture('sprite_48_0')) {
      ...
      const anim48 = this.anims.add(new FrameAnimatedSprite({
    ...
    if (textures.hasTexture('sprite_51_0')) {
      ...
      const anim51 = this.anims.add(new FrameAnimatedSprite({
    ...
    if (textures.hasTexture('sprite_21_0')) {
      ...
      const anim21 = this.anims.add(new FrameAnimatedSprite({
    ...
    if (textures.hasTexture('sprite_22_0')) {
      ...
      const anim22 = this.anims.add(new FrameAnimatedSprite({
    ...
    if (textures.hasTexture('sprite_56_0')) {
      ...
      const anim56 = this.anims.add(new FrameAnimatedSprite({
    ...
    if (textures.hasTexture('sprite_57_0')) {
      ...
      const anim57 = this.anims.add(new FrameAnimatedSprite({
    ...
    if (textures.hasTexture('sprite_27_0')) {
      ...
      const anim27 = this.anims.add(new FrameAnimatedSprite({
    ...
    if (textures.hasTexture('sprite_34_0')) {
      ...
      this.sprite34Anim = this.anims.add(new FrameAnimatedSprite({
      ...
      this.sprite34Anim
        .onFrame(8, () => { this.sprite34Flickering = true; }, false)
    ...
    if (textures.hasTexture('sprite_35_0')) {
      ...
      this.sprite35Anim = this.anims.add(new FrameAnimatedSprite({
      ...
      this.sprite35Anim
        .onFrame(8, () => { this.sprite35Flickering = true; }, false)
        .onFrame(23, () => this.signalHit());
  ...
  update(deltaTime: number): void {
    ...
    if (this.sprite34Anim && this.sprite34Flickering && !this.sprite34Anim.isComplete()) {
      this.sprite34Anim.sprite.alpha = Math.floor(Math.random() * 100) / 100;
    }

    // Apply alpha flicker for sprite_35 (AS: _alpha = random(100))
    if (this.sprite35Anim && this.sprite35Flickering && !this.sprite35Anim.isComplete()) {
